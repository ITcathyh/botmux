...
export const messages: Record<string, string> = {
  ...
  'cmd.reply_mode.status_inherited': 'Current group reply mode: {mode} (inherits bot default: {default})\nCommands: /reply-mode inherit | chat | chat-topic | topic | new-topic',
  'cmd.reply_mode.status_override': 'Current group reply mode: {mode} (group override; bot default: {default})\nCommands: /reply-mode inherit | chat | chat-topic | topic | new-topic',
  'cmd.reply_mode.updated': '✅ Group reply mode updated to: {mode}',
  'cmd.reply_mode.inherited': '✅ Group override cleared; inheriting bot default: {default} (effective: {mode})',
  ...
  'help.reply_mode': '/reply-mode [status|inherit|chat|chat-topic|topic|new-topic] - Show/change regular-group or DM reply/session mode',
